...
## What It Can Do
-  **Canteen** — prices, menu, budget recommendations  
-  **Teachers** — real-time location based on current timetable slot  
-  **Events** — upcoming college events and workshops  
-  **Xerox** — compare AC vs Non-AC shop speed and variety  
-  **Vending Machine** — what's available near hostel 24/7  
-  **Community** — Reddit-style discussion board with `@ves.ac.in` auth, upvoting, and auto-moderation.
...
- [x] **increased the response speed:** the speed has the been increased to currently at 400ms to 200ms
