...
# Check if GROQ_VOICE_KEY is available
...
if voice_key:
    try:
        ...
        # Public domain sample audio file
        sample_audio_url = "https://upload.wikimedia.org/wikipedia/commons/1/1f/George_W_Bush_Columbia_FINAL.ogg"
